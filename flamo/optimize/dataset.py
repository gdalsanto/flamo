...
class DatasetColorless(Dataset):
    ...
    corresponding to a flat magnitude spectrum.
        ...
        **Arguments / Attributes**:
            ...
            - **device** (torch.device, optional): The device to use for computation. Defaults to torch default device.
...
def split_dataset(
    ...
    Splits the given dataset into a training set and a validation set based on the specified split ratio.
        ...
        **Arguments**:
            ...
            - **device** (torch.device, optional): The device to use for the random split generator. Defaults to torch default device.
...
def load_dataset(
    ...
    train_set, valid_set = split_dataset(dataset, split, device)
